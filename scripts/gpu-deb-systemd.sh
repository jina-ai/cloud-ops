...
sudo bash <<INIT
    ...
    yum update && yum -y install python3.8 python3.8-dev python3.8-distutils python3.8-venv python3-pip && \
        yum install --no-install-recommends -y ruby-dev build-essential && \
